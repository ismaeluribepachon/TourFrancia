...
public class UpdateCiclista extends HttpServlet {
            ...
            if(!(sesion == null) || !(sesion.getAttribute("userTour") == null)){
                if(request.getParameter("nombre") != null || request.getParameter("dorsal") != null || request.getParameter("equipo") != null){
                    try{
                        ...
                        respuesta = ConexionBD.getInstance().update(new Ciclista(ConexionBD.getInstance().getCiclista(nombre).getIdCiclista(), nombre, dorsal, equipo, ""));
